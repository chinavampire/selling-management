                ...
                <div class="row">
                    <div class="contact-us">
                            <div class="col-lg-12">
                                ...
                                <form action="index.php?action=blog&page=1" method="POST" id="checkform" class="contact-form" enctype="multipart/form-data" onSubmit="return checkform(this);">
...
var ret=0;
            ...
            $.ajax({
                type: "POST",
                dataType: "html",
                url: "template/ajax/chkblog.php",
                async:false,
                data: $("#checkform").serialize(),
                success: function (result) {
if (result=="exist") {
alert ("Already exists ! Please change category or title.");
ret++;
}
...
if (ret>0)
{
    ...
    return (false);
                            ...
                            <div class="paymeny-information" id="uploadform">
                                        ...
                                        <input type="text" class="form-control" name="title" placeholder="Title" maxlength="20" required="required" id="getfocus"/>
                                        <input type="text" class="form-control" name="location" placeholder="Location" maxlength="20" />
                                        <input type="date" class="form-control" name="date" placeholder="Date" value=$curdate />
                                        <textarea class="form-control text-area" rows="3" name="text" placeholder="Text" maxlength="150"></textarea>
...
<br><br>
                                    ...
                                    <button type="submit" name="newblog" class="btn btn-default">Confirm</button>
                                </form>
                            </div>
                    </div>
                </div>
